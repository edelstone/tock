...
4. On first launch you'll be prompted to add Tock to your login items. You can change this setting later in Tock settings or **System Settings → General → Login Items**.
